...
def generate_launch_description():
    frame_id = LaunchConfiguration('frame_id',default='rpildar_frame')
    ...
    lakibeam1_tf = Node(
            ...
            arguments=[
                '--x', '-0.086', '--y', '0.044', '--z', '0',
                '--qx', '0', '--qy', '0', '--qz', '1.00', '--qw', '0',
                '--frame-id', 'base_link', '--child-frame-id', 'rplidar_frame'
            ] )
